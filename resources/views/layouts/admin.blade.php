...
<head>
  ...
  <title>{{ config('app.name', 'Laravel') . __(' Panel Admin') }}</title>
    ...
    <div class="row">
      <div class="col-lg-2 p-0">
        <div class="sidebar d-sm-none d-md-block d-lg-block elegant-color-dark">
          ...
          <hr class="mb-0" />
          <a href="{{ url('/admin/') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'index' ? ' active' : '') }}">
              <i class="fas fa-tachometer-alt mr-3"></i>
              Dashboard
            </div>
          </a>
          <a href="{{ url('/admin/penulis') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'penulis' ? ' active' : '') }}">
              <i class="fas fa-chalkboard-teacher mr-3"></i>
              Penulis
            </div>
          </a>
          <a href="{{ url('/admin/siswa') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'siswa' ? ' active' : '') }}">
              <i class="fas fa-users mr-3"></i>
              Siswa
            </div>
          </a>
          <a href="{{ url('/admin/kategori') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'kategori' ? ' active' : '') }}">
              <i class="fas fa-tag mr-3"></i>
              Kategori
            </div>
          </a>
          <a href="{{ url('/admin/subkategori') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ $active == 'subkategori' ? ' active' : '' }}">
              <i class="fas fa-tags mr-3"></i>
              Subkategori
            </div>
          </a>
          <a href="{{ url('/admin/buku') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'buku' ? ' active' : '') }}">
              <i class="fas fa-book mr-3"></i>
              Buku
            </div>
          </a>
          <a href="{{ url('/admin/laporan') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'laporan' ? ' active' : '') }}">
          ...
          <a href="{{ url('/admin/pengaturan') }}">
            <div class="col-sm-12 text-light py-3 sidebar-item{{ ($active == 'pengaturan' ? ' active' : '') }}">
